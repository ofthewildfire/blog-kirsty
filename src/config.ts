...
export const siteConfig: SiteConfig = {
  ...
  description: "A record of CS studies, backend development, and the transition to software engineering.",
  // [CONFIG:SITE_AUTHOR]
  author: "Kirsty ",
  ...
  fonts: {
    ...
    families: {
      // [CONFIG:FONT_BODY]
      body: "Libre Baskerville",      // Body text font family
      // [CONFIG:FONT_HEADING]
